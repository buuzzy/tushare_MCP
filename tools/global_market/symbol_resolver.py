...
INDEX_ALIASES: dict[str, tuple[str, str]] = {
    ...
    "恒生科技": ("100.HSTECH", "恒生科技指数"),
    "恒生科技指数": ("100.HSTECH", "恒生科技指数"),
    "DJIA": ("100.DJIA", "道琼斯工业指数"),
    "道指": ("100.DJIA", "道琼斯工业指数"),
    "DJI": ("100.DJIA", "道琼斯工业指数"),
    "SPX": ("100.SPX", "标普500指数"),
    "标普500": ("100.SPX", "标普500指数"),
    "标普": ("100.SPX", "标普500指数"),
    "GSPC": ("100.SPX", "标普500指数"),
    "NDX": ("100.NDX", "纳斯达克100指数"),
    "纳斯达克100": ("100.NDX", "纳斯达克100指数"),
    "IXIC": ("100.IXIC", "纳斯达克综合指数"),
    "纳指": ("100.IXIC", "纳斯达克综合指数"),
    "纳斯达克指数": ("100.IXIC", "纳斯达克综合指数"),
    "VIX": ("100.VIX", "波动率指数"),
}
